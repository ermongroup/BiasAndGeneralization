...
def main(args):
  output_image_dir = '../dataset/%s/images/'%(args.gen_list)
  output_scene_dir = '../dataset/%s/scenes/'%(args.gen_list)
  output_scene_file = '../dataset/%s/CLEVR_scenes.json'%(args.gen_list)
  args.properties_json = 'data/combinations.json'
...
def add_random_objects(scene_struct, num_objects, args, camera, gen_list):
  ...
  for i in range(num_objects):
    ...
    while True:
      ...
      y += rn
      x -= rn # Make the two objects located roughly side by side
