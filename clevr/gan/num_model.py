...
class DCGAN(object):
  def __init__(self, sess, data_str, d_iter, g_iter, f_iter, wdf_iter, gp_coef,
         ...
         model_name='DCGAN', base_name='CNN', decay=True):
    """
    Args:
    ...
    # self.data_str = './blender/clevr-dataset-gen/output/images/'
    self.data_str = data_str
    self.dataset_config = dataset_name.split('-')
